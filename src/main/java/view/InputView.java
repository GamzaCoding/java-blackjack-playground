...
public class InputView {
    ...
    private static final String TAKE_ONE_MORE_CARD = "는 한장의 카드를 더 받겠습니까?(예는 y, 아니오는 n)";
    private static final String ANOTHER_INPUT_ERROR = "y, n 둘중 하나의 답만 가능합니다.";
    ...
    public String askTakeOneMoreCard(String name){
        String answer;
        System.out.println(name + TAKE_ONE_MORE_CARD);
        ...
        if(!answer.equals("y")){
            if(!answer.equals("n")){
                throw new IllegalArgumentException(ANOTHER_INPUT_ERROR);
            }
        }
